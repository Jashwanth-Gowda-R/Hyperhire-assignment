class AppConst {
  ...
  static const String mainDetails = '지난 월요일에 했던 이벤트 중 가장 괜찮은 상품 뭐야?\n';
...
있었던 팝들 있으면 어땠는지 후기 좀 공유해주라~~! ''';
  ...
  static const String comment1 = '''어머 제가 있던 테이블이 제일 반응이 좋았나보네요🤭 
우짤래미님도 아시겠지만 저도 일반인 몸매 그 이상도 이하도
아니잖아요?! 그런 제가 기꺼이 도전해봤는데 생각보다
괜찮았어요! 오늘 중으로 라이브 리뷰 올라온다고 하니
꼭 봐주세용~!''';

  static const String comment2 = '''오 대박! 라이브 리뷰 오늘 올라온대요? 챙겨봐야겠다''';
}
